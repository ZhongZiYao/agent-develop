...
from src.crawlers.spiders.nga_spider import NgaSpider


def main() -> int:
    parser = argparse.ArgumentParser()
    parser.add_argument("--game", default="onmyoji",
                        choices=["onmyoji", "genshin", "yjwj", "arknights"])
    parser.add_argument("--mode", default="essence", choices=["essence", "latest"])
