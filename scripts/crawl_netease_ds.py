"""Driver: 跑网易大神 spider（HTML 静态降级，无需登录态）。"""
...
from src.crawlers.spiders.netease_ds_spider import NeteaseDsSpider


def main() -> int:
    parser = argparse.ArgumentParser()
    parser.add_argument("--game", default="onmyoji",
                        choices=["onmyoji", "yjwj", "dwrg", "hyxd", "mrz", "qnyh"])
